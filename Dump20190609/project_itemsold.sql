...
CREATE TABLE `itemsold` (
  ...
  `SoldName` varchar(20) NOT NULL,
  `SoldPrice` varchar(20) NOT NULL,
  `SoldAmount` varchar(20) NOT NULL,
  `SoldDate` varchar(20) NOT NULL,
  `MemberNumber` varchar(20) NOT NULL,
  PRIMARY KEY (`SoldNumber`),
  KEY `MemberNumber` (`MemberNumber`),
  CONSTRAINT `itemsold_ibfk_1` FOREIGN KEY (`MemberNumber`) REFERENCES `members` (`MemberNumber`)
...
-- Dump completed on 2019-06-09  9:30:40
