...
--
-- Table structure for table `use_order`
--
...
CREATE TABLE `use_order` (
  ...
  `ImportNumber` varchar(20) NOT NULL,
  `CompanyNumber` varchar(20) NOT NULL,
  PRIMARY KEY (`OrderNumber`),
  KEY `CompanyNumber` (`CompanyNumber`),
  CONSTRAINT `use_order_ibfk_1` FOREIGN KEY (`CompanyNumber`) REFERENCES `company` (`CompanyNumber`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `use_order`
--
